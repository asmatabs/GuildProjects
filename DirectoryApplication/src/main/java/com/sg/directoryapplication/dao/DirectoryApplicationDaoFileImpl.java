 ...
 * @author asmat
 */
public class DirectoryApplicationDaoFileImpl implements DirectoryApplicationDao {

    private Map<Integer, Person> persons = new HashMap<>();

    @Override
    public Person addPerson(int personId, Person person) {
        Person newPerson = persons.put(personId, person);
        return newPerson;
    }
